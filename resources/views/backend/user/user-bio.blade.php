...
@section('content')
    ...
    @if($certificate != null)
        ...
        <div class="container">
            <div class="row">
                <img class="img-fluid" src="{{asset('storage/images/certificate/'.$certificate->certificate)}}" alt="">
            </div>
            <div class="row mx-auto my-3">
                <div class="col-md-3 mx-auto">
                    <a href="{{ route('certificate.download', $user->pass_no) }}" class="btn btn-primary btn-lg">Download Certificate</a>
                </div>
            </div>
        </div>
    @endif
